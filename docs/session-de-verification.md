...
Tout ce qui se vérifie sans yeux l'est déjà : **1142 tests headless** et **17 gametests**
...
## Bloc 3 — L'exécution (9 points, ~30 min)
...
Le tableau des 44 points reste dans [`README.md`](README.md) : cochez-y ce qui est vu.

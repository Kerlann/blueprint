...
Tout ce qui se vérifie sans yeux l'est déjà : **1026 tests headless** et **17 gametests**
...
## Bloc 2 — Les écrans (10 points, ~22 min)
...
Le tableau des 36 points reste dans [`README.md`](README.md) : cochez-y ce qui est vu.

...
**Les neuf épics du PRD sont livrés, plus trois nés de l'usage.** 82 stories en statut
*Done*, 81 gates QA (certaines couvrent des stories groupées) toutes en verdict *PASS*
...
| 12 | **L'éditeur à l'usage** | 12.1 → | 1 PASS |

**Vérification automatique** : `./gradlew build` (1 175 tests headless, couverture

...
**Les neuf épics du PRD sont livrés.** 51 stories en statut *Done*, 50 gates QA
...
| 5 | Éditeur visuel | 5.1 → 5.12 | 16 PASS |
...
**19 points à regarder**, listés dans [`README.md` §Prochaine action](README.md).
...
1. **Le rendu n'est vérifié par aucun test.** L'état de l'éditeur est couvert
   ...
   d'être des 19 points de la session en jeu.

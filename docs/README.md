...
| 5 | Éditeur visuel | 5.1, 5.2a | **Ready for Review** — canevas (pan, zoom, grille, culling, banc NFR1) + rendu descripteur, sélection/déplacement/suppression ; F6 sur la démo (branche `worktree-epic5-editeur`) |

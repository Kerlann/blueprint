...
| [`session-de-verification.md`](session-de-verification.md) | QA | **Ce qui reste à voir en jeu** : 41 points en quatre blocs, une heure |
...
**Les 79 stories du projet sont closes**, chacune avec son gate PASS.
...
> quarante-et-un points restants, groupés par ce qu'il faut ouvrir plutôt que par numéro de story,

...
| 10 | **Interfaces graphiques** | 10.1 → 10.9 | **En cours** — 10.1 à 10.4 closes, 4 gates PASS ; les écrans sont VIVANTS (clic → graphe → écran). **10.5 (packs de ressources) est la prochaine à prendre** |

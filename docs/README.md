...
| [`session-de-verification.md`](session-de-verification.md) | QA | **Ce qui reste à voir en jeu** : 39 points en quatre blocs, une heure |
...
**Les 74 stories du projet sont closes**, chacune avec son gate PASS.
...
> trente-neuf points restants, groupés par ce qu'il faut ouvrir plutôt que par numéro de story,

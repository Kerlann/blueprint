...
| [`session-de-verification.md`](session-de-verification.md) | QA | **Ce qui reste à voir en jeu** : 32 points en quatre blocs, une heure |
...
**L'épic 10 (interfaces graphiques) est livré** : **douze** stories, de la structure de
...
**Les 67 stories du projet sont closes**, chacune avec son gate PASS.
...
> trente-deux points restants, groupés par ce qu'il faut ouvrir plutôt que par numéro de story,

...
public record Theme(int canvasBackground, int grid, int gridMajor,
                    ...
                    int ghost, int error, int warning, int execWire, int debugActive) {

    /** Compatibilité : thème sans couleur de débogage (ajoutée en 9.1b). */
    public Theme(int canvasBackground, int grid, int gridMajor,
                 int nodeBackground, int nodeBorder, int nodeSelected,
                 int ghost, int error, int warning, int execWire) {
        this(canvasBackground, grid, gridMajor, nodeBackground, nodeBorder, nodeSelected,
                ghost, error, warning, execWire, 0xFFFFD866);
    }

    public static final Theme DEFAULT = new Theme(
            0xFF1A1B1E, 0xFF242629, 0xFF2E3135,
            0xFF2B2D31, 0xFF3A3D42, 0xFF7AA2F7,
            0xFFC74A5B, 0xFFF7768E, 0xFFE0AF68, 0xFFE6E6E6, 0xFFFFD866);
    ...
    public static final Theme HIGH_CONTRAST = new Theme(
            ...
            0xFFFF4455, 0xFFFF3355, 0xFFFFB300, 0xFFFFFFFF, 0xFFFFEE00);
